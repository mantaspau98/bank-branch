...
class CommissionCashInNat implements Commission
{
    const DEFAULT_CASHIN_NATURAL_COMMISION = '0.0003';

    public function Calculate(Transaction $transaction): Cash
    {
        $commision = bcmul($transaction->getCash()->getAmount(), self::DEFAULT_CASHIN_NATURAL_COMMISION, 10);
